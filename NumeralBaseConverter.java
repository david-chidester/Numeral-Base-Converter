...
*   but WITHOUT ANY WARRANTY; without even the implied warranty of/*  <Numeral Base Converter>
*   Copyright (C) <2019>>  <David N. Tishkoff Chidester>
*
*   This program is free software: you can redistribute it and/or modify
*   it under the terms of the GNU General Public License as published by
...
public class NumeralBaseConverter {
	...
	public static void main(String args[]) throws java.io.IOException {
		...
		// testing for bad numeral input beginning with 0s such as 005
			...
			// algorithm works with backwards numeral string
			StringBuilder backwardsNumeral = new StringBuilder();
			backwardsNumeral.append(args[0]);

			// printing result
			if (validArgs)
				System.out.println(convertNumBase(backwardsNumeral.reverse().toString(), inputBase, outputBase));
		}
	}
